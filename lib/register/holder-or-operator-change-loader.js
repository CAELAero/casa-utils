    ...
    static listAllChanges(source) {
        ...
        sheet_data.forEach((row) => {
            try {
                ...
                const holder_add = Address.create2Line(CASALoaderUtils.parseString(row[6]), CASALoaderUtils.parseString(row[7]), CASALoaderUtils.parseString(row[8]), CASALoaderUtils.parseString(row[9]), holder_postcode, CASALoaderUtils.parseString(row[11]));
                ...
                const operator_add = Address.create2Line(CASALoaderUtils.parseString(row[13]), CASALoaderUtils.parseString(row[14]), CASALoaderUtils.parseString(row[15]), CASALoaderUtils.parseString(row[16]), operator_postcode, CASALoaderUtils.parseString(row[18]));
...
//# sourceMappingURL=holder-or-operator-change-loader.js.map