 ...
 */
export declare class CASAHolderOrOperatorChangeLoader {
    /**
     ...
     *   a zero length array
     */
    static listAllChanges(source: string): HolderOrOperatorChangeData[];
}
//# sourceMappingURL=holder-or-operator-change-loader.d.ts.map